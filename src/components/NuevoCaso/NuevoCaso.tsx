...
const NuevoCaso = () => {
  ...
  const handleChange = (e) => {
    ...
    setInfPaciente((prevInfPaciente) => ({
      ...prevInfPaciente,
      [name]: value,
      expedicion: name === "expedicion" ? selectTagValue : prevInfPaciente.expedicion,
      sexo: name === "sexo" ? selectGenero : prevInfPaciente.sexo,
      edad: name === "edad" ? selectEdad : prevInfPaciente.edad,
      fechaDiagnostico: new Date()
        .toISOString()
        .split("T")[0]
        .split("-")
